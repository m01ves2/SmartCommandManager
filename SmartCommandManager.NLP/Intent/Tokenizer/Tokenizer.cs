    ...
    public class Tokenizer : ITokenizer
    {
        ...
        private State ProcessCharOutsideToken(char c, TokenBuilder builder)
        {
            if (builder.HasData() || builder.IsQuoted || builder.QuoteChar != null)
                throw new InvalidOperationException("Tokenizer public error: Outside but builder not empty");
        ...
        private State ProcessCharInsideToken(char c, TokenBuilder builder, out Token? newToken)
        {
            if (builder.IsQuoted || builder.QuoteChar != null)
                throw new InvalidOperationException("Tokenizer public error: InsideToken but quoted flags set");
        ...
        {
            if (!builder.IsQuoted || builder.QuoteChar == null)
                throw new InvalidOperationException("Tokenizer public error: InsideQuoted but QuoteChar not set");
